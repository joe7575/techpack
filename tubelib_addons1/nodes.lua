...
if farming.mod == "redo" then
	...
	fn("farming:carrot_8",    "farming:carrot_2",       "farming:carrot_1")
	fn("farming:potato_4",    "farming:potato_3",       "farming:potato_1")
	fn("farming:tomato_8",    "farming:tomato_3",       "farming:tomato_1")
	fn("farming:cucumber_4",  "farming:cucumber_2",     "farming:cucumber_1")
	fn("farming:corn_8",      "farming:corn_2",         "farming:corn_1")
	fn("farming:coffee_5",    "farming:coffee_beans_2", "farming:coffee_1")
	fn("farming:melon_8",     "farming:melon_slice_4",  "farming:melon_1")
	fn("farming:pumpkin_8",   "farming:pumpkin_slice_4","farming:pumpkin_1")
	...
	fn("farming:rhubarb_3",   "farming:rhubarb_2",      "farming:rhubarb_1")
	fn("farming:beanpole_5",  "farming:beans_3",        "farming:beanpole_1")
	fn("farming:grapes_8",    "farming:grapes_3",       "farming:grapes_1")
	fn("farming:barley_7",    "farming:barley",         "farming:barley_1")
	fn("farming:chili_8",     "farming:chili_pepper_2", "farming:chili_1")
	...
	fn('farming:beetroot_5',  'farming:beetroot_2',     'farming:beetroot_1')
	fn('farming:cocoa_4',     'farming:cocoa_beans_2',  'farming:cocoa_1')
	fn('farming:garlic_5',    'farming:garlic_2',       'farming:garlic_1')
	fn('farming:onion_5',     'farming:onion_2',        'farming:onion_1')
	fn('farming:pea_5',       'farming:pea_pod_3',      'farming:pea_1')
	fn('farming:pepper_5',    'farming:pepper_2',       'farming:pepper_1')
	fn('farming:pepper_6',    'farming:pepper_yellow_2','farming:pepper_1')
	fn('farming:pepper_7',    'farming:pepper_red_2',   'farming:pepper_1')
	fn('farming:pineapple_8', 'farming:pineapple_1',    'farming:pineapple_1')
end
...
fn("ethereal:onion_5",        "ethereal:wild_onion_plant_2", "ethereal:onion_1")
